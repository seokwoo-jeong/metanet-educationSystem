...
public class StudentController {
	...
	public String studentApplyClass(Model model, HttpServletRequest request, HttpSession session,RedirectAttributes rttr) throws Exception {
	...
	public String studentDeleteClass(Model model, HttpServletRequest request, HttpSession session,RedirectAttributes rttr) throws Exception {
		String classNO = request.getParameter("classNO");
