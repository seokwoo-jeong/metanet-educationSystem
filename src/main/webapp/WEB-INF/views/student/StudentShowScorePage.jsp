											...
											<tbody>
												<c:forEach var="studentScoreVO" items="${studentScoreVOList}">
													<tr>
														...
														<td>${studentScoreVO.ScoreVO.midtermScore}</td>
														<td>${studentScoreVO.ScoreVO.finalsScore}</td>
														<td>${studentScoreVO.ScoreVO.assignmentScore}</td>
														<td>${studentScoreVO.ScoreVO.attendanceScore}</td>
